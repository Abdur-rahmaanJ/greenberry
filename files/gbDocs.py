# -*- coding: utf-8 -*-
"""
Created on Fri Dec 29 22:52:29 2017
...
2 printing
    ...
    engine : 
        std eval - soon replaced by stacked Polish Notation engine4
    ===
    print (2+3-4)
    > 1
...
5 comparisons
    ...
    if gfregg 4g4tg = g35g34554g : print 1
    > 
...
7 classes
    ...
    7.3 see attributes / characteristics
    see power of Man
    > 10
    
    
TODO
- add eval in comparison
- add vars in eval  
    
"""
def x(**keyword_parameters):
    print(keyword_parameters)
    if ('name' in keyword_parameters):
        if keyword_parameters['name'] == 1:
            print(0)
        else:
            print(9)
    print('leaving')
